...
.btn-toggle:not(.collapsed) .btntext {
    background-color: var(--sidebarred);
    transition: all .5s;
}
...
.collapse.show {
    padding-top: 2rem;
    margin-top: -2rem;
    background-color: var(--collapsedbg);
    transition: all .5s;
}
...
.btn-toggle:not(.collapsed)::after {
    ...
    border-color: var(--sidebarred) transparent transparent transparent;
